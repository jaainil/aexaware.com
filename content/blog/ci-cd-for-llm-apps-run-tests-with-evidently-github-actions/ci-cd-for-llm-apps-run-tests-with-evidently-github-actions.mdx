...
image: "/blog-images/ci-cd-for-llm-apps-run-tests-with-evidently-github-actions/cover.jpg"
tags: []
---
...
![LLM regression testing](/blog-images/ci-cd-for-llm-apps-run-tests-with-evidently-github-actions/image-0.png)
...
![Reference-based LLM evals](/blog-images/ci-cd-for-llm-apps-run-tests-with-evidently-github-actions/image-1.png)
