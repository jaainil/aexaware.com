...
const SERVICES = [
  ...
  // AI & Data
  { name: "AI & Machine Learning", slug: "ai-ml-integration", category: "AI & Data", description: "Custom chatbots and LLM integration, AI agents and workflow automation with MCP servers and RAG pipelines, generative image/video, predictive analytics, computer vision, NLP, and data engineering with BI.", url: "https://aexaware.com/services/ai-ml-integration", techStack: ["OpenAI", "Anthropic", "LangChain", "Python", "pgvector", "Pinecone", "MCP", "Stable Diffusion", "Kafka", "Snowflake"] },
  // Infrastructure
