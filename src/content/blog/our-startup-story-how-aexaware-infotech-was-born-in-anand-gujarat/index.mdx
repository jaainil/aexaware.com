...
**Reference-based evaluations** work by comparing the AI-generated responses against expected "ground truth" answers, allowing you to detect when outputs deviate from the desired behavior.